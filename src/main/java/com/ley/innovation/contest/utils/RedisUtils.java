...
public class RedisUtils {
    ...
    /**
     * return keys in redis
     *
     * @param pattern the search keys pattern
     **/
    ...
    public long ssize(String key) {
        return this.hasKey(key) ? redisTemplate.opsForValue().size(key) : 0L;
    }
    ...
    public static enum ListPosition {
        ...
        /**
         * List position from the first element.
         **/
        LEFT(0),


        /**
         * List position from the last element
         **/
        RIGHT(-1);
